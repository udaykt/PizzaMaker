...
export const PRESET_PIZZAS = [
  ...
  },
  {
    ...
    config: {
      ...
      bakeLevel: 'well-done',
      base: {
        sauce: { sauceType: 'garlic-parmesan' },
        ...noCheese(),
        mozzarella:     { checked: true },
        cheddar:        { checked: true },
        parmesanAsiago: { checked: true },
        ricotta:        { checked: true },
      },
      toppings: { ...noToppings() },
    },
  },
  {
    ...
    config: {
      ...
      toppings: {
        ...noToppings(),
        chicken:  { checked: true, quantity: 'extra' },
        spinach:  { checked: true, quantity: 'regular' },
        mushroom: { checked: true, quantity: 'light' },
        onion:    { checked: true, quantity: 'light' },
      },
    },
  },
  {
    id: 'pepperoni-mushroom',
  ...
  {
    id: 'smoky-bbq-veggie',
    name: 'Smoky BBQ Veggie',
    config: {
      size: 'medium',
      crustStyle: 'hand-tossed',
      bakeLevel: 'well-done',
      base: { sauce: { sauceType: 'bbq' }, ...noCheese(), mozzarella: { checked: true }, veganCheese: { checked: true } },
      toppings: {
        ...noToppings(),
        mushroom: { checked: true, quantity: 'regular' },
        peppers:  { checked: true, quantity: 'regular' },
        corn:     { checked: true, quantity: 'regular' },
        onion:    { checked: true, quantity: 'regular' },
        zucchini: { checked: true, quantity: 'light' },
      },
    },
  },
  {
  ...
  },
  {
    ...
    config: {
      ...
      toppings: {
        ...
        pepperoni: { checked: true, quantity: 'extra' },
        sausage:   { checked: true, quantity: 'extra' },
        bacon:     { checked: true, quantity: 'extra' },
        chicken:   { checked: true, quantity: 'regular' },
        onion:     { checked: true, quantity: 'light' },
      },
    },
